...
model1 = pickle.load(open(path+'final_model_logR.sav', 'rb'))

model3 = pickle.load(open(path+'final_model_passive.sav', 'rb'))
model4 = pickle.load(open(path+'final_model_randomClassifier.sav', 'rb'))
...
@app.route('/about_us')
def about_us():
    sir=os.path.join(app.config['UPLOAD_FOLDER'],'anunay sir.jpg')
    suman=os.path.join(app.config['UPLOAD_FOLDER'],'suman2.jpg')
    souma=os.path.join(app.config['UPLOAD_FOLDER'],'souma.jpg')
    saikot=os.path.join(app.config['UPLOAD_FOLDER'],'saikot.jpg')
    spandan=os.path.join(app.config['UPLOAD_FOLDER'],'spandan.jpg')
    namrata=os.path.join(app.config['UPLOAD_FOLDER'],'namrata.jpg')
    sws=os.path.join(app.config['UPLOAD_FOLDER'],'sws.jpg')
    subho=os.path.join(app.config['UPLOAD_FOLDER'],'subho.jpg')
    pritam=os.path.join(app.config['UPLOAD_FOLDER'],'pritam.jpg')
    bikram=os.path.join(app.config['UPLOAD_FOLDER'],'bikram.jpg')
    suvam=os.path.join(app.config['UPLOAD_FOLDER'],'suvam.jpg')
    return  render_template('aboutus.html',sir=sir,suman=suman,souma=souma,saikot=saikot,spandan=spandan,namrata=namrata,sws=sws,subho=subho,pritam=pritam,bikram=bikram,suvam=suvam)   
